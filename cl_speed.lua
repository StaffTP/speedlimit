        ...
        speedlimit = 25
            ...
            if speedlimitshow == true then
                ...
                if(speed < speedlimit) then
                  DrawTxt(0.674, 1.356, 1.0,1.0,0.42,"~w~Speedlimit: ~c~"..speedlimit.." mph", 255,255,255,255)
                elseif speed - speedlimit <= 5 then
                    DrawTxt(0.674, 1.356, 1.0,1.0,0.42,"~w~Speedlimit: ~y~"..speedlimit.." mph", 255,255,255,255)
                elseif speed > speedlimit then 
                  DrawTxt(0.674, 1.356, 1.0,1.0,0.42,"~w~Speedlimit: ~r~"..speedlimit.." mph", 255,255,255,255)
                end
			end
		end
    end
